...
-- OWNER: keyzorxz | USER ID: 2043745142
...
AutoFarm:AddSwitch("auto Glitch)", function(state)
...
if IS_OWNER then
    print("\n=====================================")
    print("[KEYZLRXZ'S HUB] ALL FEATURES ACTIVE!")
    print("=====================================\n")
    ...
    print("\n=====================================")
    print("[KEYZORXZ'S HUB] READY TO GO! EVERYTHING WORKS!")
    print("=====================================")
else
